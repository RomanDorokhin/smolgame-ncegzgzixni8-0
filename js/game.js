...
const G = typeof window !== 'undefined' ? window._G_SINGLETON : localG;
...
function spawnSoulParticles(x, y, color, count, lifeMult = 1) {
  for (let i = 0; i < count; i++) {
